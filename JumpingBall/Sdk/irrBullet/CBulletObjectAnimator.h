...
//extern btTriangleIndexVertexArray* ConvertIrrMeshToBulletTriangleArray(irr::scene::IMesh* , const irr::core::vector3df&);
//extern btTriangleMesh* ConvertIrrMeshToBulletTriangleMesh(irr::scene::IMesh* , const irr::core::vector3df&);
//extern btConvexHullShape* ConvertIrrMeshToBulletConvexHullShape(irr::scene::IMesh* , const irr::core::vector3df&);
...
{	
  ...
  struct CBulletObjectAnimatorGeometry 
  {
	  ...
	  { type = CBPAGT_NONE; geometryUnion.mesh.irrMesh = NULL; }
	  CBulletObjectAnimatorGeometry(const CBulletObjectAnimatorGeometry& obj) 
	  { type = obj.type; meshFile = obj.meshFile; geometryUnion.sphere = obj.geometryUnion.sphere; geometryUnion.box = obj.geometryUnion.box; geometryUnion.mesh = obj.geometryUnion.mesh; }

	  CBulletObjectAnimatorGeometryTypes type;
	  union UGeometryUnion
	  {
		  struct CSphereGeom 
		  {
  ...
  struct CBulletObjectAnimatorParams 
  {
	  CBulletObjectAnimatorParams() : mass(1.0f), ccdThreshold(0.0f), 
		  ...
		  linearFactor(1.f, 1.f, 1.f), angularFactor(1.f, 1.f, 1.f)
	  {}
	  ...
	  //	2010. 2. 1				//
	  ////////////////////////////////
	  core::vector3df linearFactor;
	  core::vector3df angularFactor;
  };
  ...
  */
  ...
  public:
	...
	inline irr::core::vector3df getLocalPosition()
	{
		return m_LocalPos;
	}

	inline CBulletObjectAnimatorGeometry getGeometry()
	{
		return geometry;
	}
