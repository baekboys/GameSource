...
#import "SearchMainAppDelegate.h"
#import "SearchMainViewController.h"

@implementation SearchMainAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
    ...
    self.viewController = [[SearchMainViewController alloc] initWithNibName:@"SearchMainViewController" bundle:nil];
