...
#import "MultiMapAppDelegate.h"
#import "MultiMapViewController.h"

@implementation MultiMapAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
	...
	self.viewController = [[MultiMapViewController alloc] initWithNibName:@"MultiMapViewController" bundle:nil];
