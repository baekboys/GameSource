...
#import "SingleMapAppDelegate.h"
#import "SingleMapViewController.h"
#import "Restaurant.h"

@implementation SingleMapAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
	...
	restaurant.id = 0;
	restaurant.name = @"전주시청";
	restaurant.address = @"전라북도 전주시 서노송동 563-7";
	restaurant.latitude = 35.824416;
	restaurant.longitude = 127.147994;
	
	self.viewController = [[SingleMapViewController alloc] initWithNibName:@"SingleMapViewController" bundle:nil withRestaurant:restaurant];
	[restaurant release];
