...
#import "SearchByNameAppDelegate.h"
#import "SearchByNameViewController.h"

@implementation SearchByNameAppDelegate
...
{
	self.viewController = [[SearchByNameViewController alloc] initWithNibName:@"SearchByNameViewController" bundle:nil];
