...
namespace scene
{
	...
	public:
		...
		void addRotation(irr::f32 vertical, irr::f32 horizontal);

		inline void setFPSCursorControl(bool control) { FPSCursorControl = control; }
		inline bool getFPSCursorContorl() { return FPSCursorControl; }
